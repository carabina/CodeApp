#
#  Be sure to run `pod spec lint codeapp.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "iticle" => "1057792866@qq.com" }
  # Or just: s.author    = "iticle"
  # s.authors            = { "iticle" => "1057792866@qq.com" }
  # s.social_media_url   = "http://twitter.com/iticle"
